...
export ANTHROPIC_DEFAULT_FABLE_MODEL="mycoroute-code-model"
export ANTHROPIC_DEFAULT_OPUS_MODEL="mycoroute-code-model"
export ANTHROPIC_DEFAULT_SONNET_MODEL="mycoroute-code-model"
export ANTHROPIC_DEFAULT_HAIKU_MODEL="mycoroute-code-model"
...
```json
{
  ...
  "env": {
    ...
    "ANTHROPIC_AUTH_TOKEN": "<mycoroute-api-key>",
    "ANTHROPIC_DEFAULT_FABLE_MODEL": "mycoroute-code-model",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "mycoroute-code-model",
    "ANTHROPIC_DEFAULT_SONNET_MODEL": "mycoroute-code-model",
    "ANTHROPIC_DEFAULT_HAIKU_MODEL": "mycoroute-code-model"
  }
}
```
...
```json
{
  "apiKeyHelper": "~/bin/get-mycoroute-key.sh",
  "env": {
    "ANTHROPIC_BASE_URL": "https://router.example.com",
    "ANTHROPIC_DEFAULT_FABLE_MODEL": "mycoroute-code-model",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "mycoroute-code-model",
...
```bash
export ANTHROPIC_CUSTOM_MODEL_OPTION="mycoroute-code-model"
