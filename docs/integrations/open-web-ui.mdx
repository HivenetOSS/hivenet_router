...
RAG_OPENAI_API_KEY=<mycoroute-api-key>
...
RAG_EXTERNAL_RERANKER_API_KEY=<mycoroute-api-key>
```
...
services:
  open-webui:
    ...
    environment:
      ...
      OPENAI_API_KEY: "${MYCOROUTE_API_KEY}"
      ENABLE_OLLAMA_API: "False"
      WEBUI_SECRET_KEY: "${WEBUI_SECRET_KEY}"
```
...
```text
MYCOROUTE_API_KEY=<mycoroute-api-key>
```
