---
title: "API keys"
description: "Generate, configure, use, reload, and manage static or dynamic Hivenet Router API keys, per-key model access, and request and token quotas over time."
