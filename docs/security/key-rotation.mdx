---
title: "Key rotation"
description: "Rotate Hivenet Router client, administrator, agent, and provider credentials with dual-issuer overlaps and the least possible request disruption."
