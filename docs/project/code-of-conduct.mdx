...
description: "Review the standards, scope, reporting process, and enforcement guidelines that apply across the Hivenet Router community."
...
<Note>
  The repository’s root [`CODE_OF_CONDUCT.md`](https://github.com/HiveNetCode/mycoroute/blob/main/CODE_OF_CONDUCT.md) is the authoritative version.

  This page summarizes how the policy applies. Refer to the canonical file for the complete wording.
</Note>

<CardGroup cols={2}>
  <Card title="Read the canonical policy" href="https://github.com/HiveNetCode/mycoroute/blob/main/CODE_OF_CONDUCT.md">
...
<CardGroup cols={2}>
  <Card title="Canonical code of conduct" href="https://github.com/HiveNetCode/mycoroute/blob/main/CODE_OF_CONDUCT.md">
