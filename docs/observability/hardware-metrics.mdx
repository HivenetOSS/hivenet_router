...
description: "Understand how Hivenet Router collects, reports, and uses GPU utilization, CPU load, and system-memory metrics from every connected agent host."
