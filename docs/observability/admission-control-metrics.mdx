...
description: "Monitor Hivenet Router admission-control occupancy, token budgets, in-flight concurrency, per-tenant limits, and request rejections broken down by gate."
