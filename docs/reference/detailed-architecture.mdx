...
| --- | --- | --- |
| `/mycoroute/router/1.0.0` | Router | Registration, heartbeat, and routing signals |
| `/mycoroute/inference/1.0.0` | Agent side of the established connection | Inference request forwarding |
...
| HTTP routes and middleware | `internal/use-the-api/server.go`, `internal/use-the-api/middleware.go` |
| Inference handlers | `internal/use-the-api/handlers.go` |
