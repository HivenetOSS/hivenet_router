...
description: "Understand when a self-hosted inference router is the right fit and what Hivenet Router adds between clients and model servers."
...
<CardGroup cols={2}>
  ...
  <Card title="Hivenet services" href="/getting-started/mycoroute-hivenet-inference-api-compute">
