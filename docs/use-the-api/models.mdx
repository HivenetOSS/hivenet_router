---
title: "Models"
description: "List Hivenet Router models available to the current API key and inspect their capabilities, agent distribution, health, and declared capacity."
sidebarTitle: "Models"
---
