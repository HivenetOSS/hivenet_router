...
Complete technical reference for Hivenet Router's architecture. For a high-level introduction, see [Architecture Overview](../Get%20Started/01-Architecture-Overview.md).

![Hivenet Router — Detailed Architecture](../images/Router.png)

## Agent Architecture

![Hivenet Agent — Detailed Architecture](../images/Agent.png)
...
- TLS derivation: HKDF-SHA256 from JWT secret → Ed25519 key pair (deterministic; salt `hivenet-router-grpc-tls-v2`)
...
```bash
GOLOG_LOG_LEVEL=debug ./bin/hivenet-router --jwt-secret-file jwt.secret
```
...
- [Architecture Overview](../Get%20Started/01-Architecture-Overview.md) - High-level introduction
- [Performance Characteristics](03-Performance-Characteristics.md) - Latency and throughput details
