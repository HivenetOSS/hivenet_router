...
description: "Use OpenAI or Anthropic as a final Hivenet Router fallback after every local agent, gate, and fallback chain step has been exhausted for a request."
