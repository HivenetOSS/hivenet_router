---
title: "Policy gates"
description: "Diagnose the seven Hivenet Router routing gates and apply practical thresholds for health, capacity, latency, engine, and hardware signals in production."
...
<Note>
  For streaming responses, Hivenet Router holds the capacity slot until the stream fully drains, whether the stream ends normally or the client disconnects. Gate 6 therefore applies for the complete lifetime of active streams.
</Note>
