...
description: "Configure Hivenet Router request caps, pool pressure shedding, token-weighted occupancy, and serverless per-key limits to protect agents under load."
