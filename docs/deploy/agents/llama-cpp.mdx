...
description: "Connect a llama.cpp server to Hivenet Router, set a stable model name, declare capacity, and expose cache, latency, and throughput metrics."
