...
description: "Deploy a Hivenet Router router and two vLLM agents across Linux hosts with Docker containers, then verify routing decisions, health, and metrics."
---
